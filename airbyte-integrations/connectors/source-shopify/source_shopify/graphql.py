...
def get_query_orders(first: int, filter_field: str, filter_value: str, next_page_token: Optional[str]):
    ...
    orders.nodes.current_total_tax_set()
    ...
    orders.nodes.total_discounts_set()
    orders.nodes.total_refunded_set()
    orders.nodes.total_refunded_shipping_set()
    orders.nodes.total_price_set()
    orders.nodes.fully_paid()
    orders.nodes.current_total_price_set()
    orders.nodes.total_capturable_set()
    orders.nodes.total_outstanding_set()
    orders.nodes.total_received_set()
    orders.nodes.refunds()
    orders.nodes.currency_code()
